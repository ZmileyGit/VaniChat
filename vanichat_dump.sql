...
--
-- Host: 127.0.0.1    Database: vanichat
-- ------------------------------------------------------
...
CREATE TABLE `mensaje` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_mensaje_1_idx` (`id_conversacion`),
  CONSTRAINT `fk_mensaje_1` FOREIGN KEY (`id_conversacion`) REFERENCES `conversacion` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-04-26 10:39:55
